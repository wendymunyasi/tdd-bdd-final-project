...
class TestProductModel(unittest.TestCase):
    ...
    def test_read_a_product(self):
        ...
        print(f"Product to be created: {product.serialize()}")
        ...
        self.assertEqual(found_product.id, product.id, "Product ID should match")
        self.assertEqual(found_product.name, product.name, "Product name should match")
        self.assertEqual(found_product.description, product.description, "Product description should match")
        self.assertEqual(found_product.price, product.price, "Product price should match")
        self.assertEqual(found_product.available, product.available, "Product availability should match")
        self.assertEqual(found_product.category, product.category, "Product category should match")
